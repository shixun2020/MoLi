...
<div id="global">
  <div class="container-fluid" style="width:1000px">  
    <div class="panel panel-default" style="width:1050px">
      <div class="panel-heading" style="font-size: 20px;">增加用户</div>
      <div class="panel-body">
            <form method="POST"  style="margin-left: 30%;">
                <div class="lan">
                  <lable>ID：</lable>
                    <div>
                      <input type="text" style="width:50%;margin-bottom: 5%;" name="ID" value="{{user.id}}"placeholder="ID">
                    </div>
                  <lable>用户名：</lable>
                    <div> 
                      <textarea  style="width:50%;"  name="username"  value="{{user.username}}" placeholder="用户名">
                      </textarea>
                    </div>
