  ...
  <body class="bg-light ">
    <div class="login bg-info p-5">
          ...
          <form method="POST"  class="d-flex flex-column">
                ...
                <div><p style="font-size: 12px;">*请输入4~18位字符</p></div>
                <div class="input-group my-3">
                ...
                <div style="margin:0px"><p style="font-size: 12px;">*请输入4~18位字符</p></div>
              ...
              <div class="input-group" style="display:flex;">
                    ...
                    <div style="padding:35px"><button class="btn btn-primary w-90 "style="background-color:white; border:1px solid gray;color:black"><a href="/hregister" style="text-decoration: none;color:black">注册</a></button></div>
              </div>
          </form>
    </div>
